...
(function (factory) {
        ...
        var picker = {},
            ...
            getToolbar = function () {
                ...
                if (options.showSwitcher) {
                    row.push($('<td>').append($('<a>').attr({ 'data-action': 'switchDate', 'title': options.tooltips.switch }).append($('<span>').html(options.icons.switch))));
                }
    ...
    $.fn.hijriDatePicker.defaults = {
        ...
        tooltips: {
            ...
            switch:'Switch to hijri/gregorian date'
        },
        useStrict: false,
        sideBySide: false,
