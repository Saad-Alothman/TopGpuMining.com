...
function setAlert(options) {
    ...
    var html = '<div class="alert alert-' + options.type + ' fade show" role="alert" ">' +
        (options.icon !== "" ? '<div class="alert-icon"><i class="' + options.icon + ' "></i></div>' : '') +
        '<div class="alert-text">' + options.message + '</div>' +
        (options.close ? '<div class="alert-close"><button type="button" class="close" data-dismiss="alert" aria-label="Close"> <span aria-hidden="true"><i class="la la-close"></i></span></button></div></div>' : '');
