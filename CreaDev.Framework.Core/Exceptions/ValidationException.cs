            ...
            foreach (var item in validationException.EntityValidationErrors)
            {
                foreach (var error in item.ValidationErrors)
                {
                    ...
                    if (error.PropertyName.Contains(".Arabic"))
                    {
                        ...
                        ValidationErrors.Add(String.Format(ErrorMessages.Required, $"{displayName} {Common.Arabic}"));
                    }
                    else if (error.PropertyName.Contains(".English"))
                    {
                        ...
                        ValidationErrors.Add(String.Format(ErrorMessages.Required, $"{displayName} {Common.English}"));
                    }
                    else
