...
{
    public class GmiServiceBase<TModel, TService> : ServiceBase<TModel, TService, GmiContext, Domain.Models.User>where TModel : GmiEntityBase where TService : class, new()
    {
